...
import { AnimatedTitle } from "./animated-hero";
...
function HeroGeometric({
  badge = "13 de maio · São Paulo, Brooklin · 13h–19h",
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
            <h1 className="font-heading text-4xl sm:text-6xl md:text-7xl font-bold mb-4 md:mb-6 tracking-tight">
              <span className="bg-clip-text text-transparent bg-gradient-to-b from-white to-white/80">
                {title1}
              </span>
              <br />
              <span className="text-4xl sm:text-5xl md:text-6xl block mt-2">
                Vendas com{" "}
                <AnimatedTitle titles={animatedTitles} />
              </span>
            </h1>
          </motion.div>
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="text-base sm:text-lg md:text-xl text-white/50 mb-10 leading-relaxed font-light tracking-wide max-w-2xl mx-auto px-4">
              Uma imersão presencial, exclusiva e aplicada para empresários que querem acelerar vendas de alto valor com processo, posicionamento e direção estratégica.
            </p>
          </motion.div>
          ...
          <motion.div custom={3} variants={fadeUpVariants} initial="hidden" animate="visible" className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#aplicar"
              className="inline-flex items-center justify-center px-8 py-4 rounded-xl bg-gradient-to-r from-indigo-500 to-rose-500 text-white font-semibold text-lg hover:opacity-90 transition-opacity cursor-pointer"
            >
